...
def simulate_sky(obs_ra=150.1049, obs_dec=2.2741, size=5001, prefix='sky_jaguar', exptime=642, filters=['F106', 'F129', 'F158'], seed=42, include_bkg=True, include_gaia=True):
    """
    ...
    include_gaia : bool
        Whether to include Gaia stars in the simulation.
    ...
    sky.gen_catalog(include_bkg=include_bkg, include_gaia=include_gaia)

    for filt in filters:
        sky.observe(filt, exptime=exptime)
